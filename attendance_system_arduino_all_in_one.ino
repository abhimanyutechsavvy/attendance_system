...
// Single Arduino sketch for the attendance system.
// Upload just this file when you want one board to handle:
// 1. RC522 RFID reads
// 2. Joystick direction + button input
// 3. Serial output back to the computer/Raspberry Pi
...
void setup() {
  ...
  Serial.println("SYSTEM:ATTENDANCE_ARDUINO_READY");
}
